...
\begin{itemize}
    ...
    \item Po základní části postupuje \textbf{8 týmů do play-off} (nejlepší 4 z každé skupiny).
    \item Play-off se hraje vyřazovacím systémem na \textbf{1 vítězný zápas}.
    \item Součástí play-off je i \textbf{zápas o 3. místo}.
\end{itemize}
...
\begin{itemize}
    ...
    \item Maximální počet hráčů v týmu: \textbf{9}.
...
\subsection*{5.1 Trestné střílení}
\begin{itemize}
    \item Každý tým nominuje \textbf{3 střelce}.
    \item Pokud není rozhodnuto, pokračuje se systémem náhlé smrti.
    \item Trestné střílení je střela z prostoru brankoviště na soupeřovu prázdnou branku. 
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item uznat technický gól,
        \item nebo nařídit trestné střlení
        \item nařídit rozehrávku
    \end{itemize}
\end{itemize}

\subsection*{6.2 Rozehrávka}
\begin{itemize}
    \item Pokud je míček vyhozen mimo hrací plochu, je nařízena rozehrávka.
    \item Rozehrává \textbf{tým, který se \textbf{ne}dotkl míčku před vyhozením}.
    \item Rozehrávka probíhá z místa, kde míček opustil hrací plochu (nebo nejbližšího vhodného bodu).
    \item Hráči soupeře musí nechat soupeře rozehrát.
    \item Rozehrávka musí být provedena bez zbytečného zdržování.
    \item Při úmyslném zdržování nebo opakovaném vyhazování může rozhodčí nařídit přísnější trest (např. trestné střílení) za zdržování hry.
\end{itemize}
...
\subsection*{7.1 Tresty}
\begin{itemize}
    \item \textbf{Menší faul} – odevzdání míče soupěři.
...
\begin{itemize}
    ...
    \item Každý hráč hraje na vlastní zodpovědnost.
\end{itemize}
...
\section*{13. Registrace}
\begin{itemize}
    \item Prezentace bude otevřená od 9:15 do 9:50.
    \item Zástupce týmu je povinen dorazit na prezentaci a dohlásit přítomnost týmu. 
    \item 9:40 bude probíhat vysvětlování pravidel.
\end{itemize}


\vfill
\begin{center}
\textit{Hraj fér. Hraj naplno. Dej si pivo.}
\end{center}
